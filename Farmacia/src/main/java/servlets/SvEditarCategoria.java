...
public class SvEditarCategoria extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Obtener el ID de la categoría y el nuevo nombre desde el formulario
        int idCategoria = Integer.parseInt(request.getParameter("id_categoria"));
        String nuevoNombreCategoria = request.getParameter("nombre_categoria_edit");

        // Llamar al método editarCategoria de la clase GestionarFarmacia
        GestionarFarmacia gestionar = new GestionarFarmacia();
        gestionar.editarCategoria(idCategoria, nuevoNombreCategoria);
