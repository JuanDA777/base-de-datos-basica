...
public class SvCategoria extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Obtener el nombre de la nueva categoría del formulario
        String nombreCategoria = request.getParameter("nombre_categoria");
        
        // Llamar al método crearCategoria de la clase GestionarFarmacia
        GestionarFarmacia gestionar = new GestionarFarmacia();
        gestionar.crearCategoria(nombreCategoria);
